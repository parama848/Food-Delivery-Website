...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("image", image); // MUST be "image"
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="outline-none py-2.5 px-3 rounded border border-gray-400"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="outline-none py-2.5 px-3 rounded border border-gray-400 resize-none"
          />
        </div>
        ...
        <button
          type="submit"
          className="w-full sm:w-fit px-10 py-2.5 bg-green-500 text-white rounded"
        >
          ADD PRODUCT
        </button>
      </form>
