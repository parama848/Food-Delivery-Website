export default function About() {
    return (
        <>
            ...
            `}</style>
            <section className="flex mt-10 flex-col md:flex-row items-center justify-center gap-10 max-md:px-4">
                ...
                <div className="text-sm text-slate-600 max-w-lg">
                    ...
                    <button className="flex items-center gap-2 mt-8 hover:-translate-y-0.5 transition bg-gradient-to-r from-green-600 to-[green] py-3 px-8 rounded-full text-white">
                        <span>Read more</span>
